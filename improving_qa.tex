...
\begin{table}
	\begin{tabular}{ l | l | l | l | l | }
		...
		\multicolumn{1}{|l|}{Core} & x & x & x & x\\ \hline
		\multicolumn{1}{|l|}{wx GUI} & x & x & x & x\\ \hline
		\multicolumn{1}{|l|}{Qt GUI} & x & x & x & x\\ \hline
	\end{tabular}
...
The old user interface made use of the VLC library for the implementation of the embedded video player. This embedded video player did not function on OS X due to incompatibilities with the wx library used for the implementation of the old interface. Requiring  

\section{Improving Sofware Artifacts}
% TODO: schrijf over documentation