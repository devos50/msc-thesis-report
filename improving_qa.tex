...
\begin{table}
	\begin{tabularx}{\textwidth}{|X|X|X|}
		...
		Dependencies on external resources & Various tests are using external resources outside the test suite, leading to unpredictable and unstable tests. & Remove the dependency on the resource or make sure that the resource is locally available (see Section \ref{subsec:external-network-resources}). \\ \hline
